...
public class JwtService {
    ...
    // 1. La Clé Secrète (Générée aléatoirement en 256 bits pour HS256)
    // En PROD, on met ça dans application.properties, pas en dur ici !
    private static final String SECRET_KEY = "404E635266556A586E3272357538782F413F4428472B4B6250645367566B5970";

    // 2. Transforme la String en objet Key utilisable par JJWT
    ...
    // 4. Extrait le username (email) du token
    ...
    // 5. Vérifie si le token est valide
